    			...
    			<div class="w-full lg:w-2/5 px-2 mb-4 lg:mb-0">
    				...
    				<div class="footer-social social mb-4">
    					<ul class="flex items-center">
    						<li><a href="https://www.facebook.com/time2top" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/icons/facebook.svg" width="22"></a></li>
    						<li class="px-4"><a href="https://www.instagram.com/time2top/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/icons/instagram.svg" width="22"></a></li>
    						<li><a href="https://www.youtube.com/channel/UCLFjGPaobP5RrvweG-p_lpA" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/icons/youtube.svg" width="25"></a></li>
    					</ul>
    				</div>
    				<div>
